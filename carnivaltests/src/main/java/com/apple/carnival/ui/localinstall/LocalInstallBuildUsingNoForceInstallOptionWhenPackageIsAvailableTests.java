...
public class LocalInstallBuildUsingNoForceInstallOptionWhenPackageIsAvailableTests {
	...
	public void init(String carnivalHost,String wd40host1, String wd40host2,String domain,String project, String packageName){
		...
		Reporter.log("LocalInstallBuildUsingNoForceInstallOptionWhenPackageIsAvailableTests tests with the following details :",true);
	...
	public void reinstallExistingPackageUsingNoForceOption() throws InterruptedException {
		...
		//package is unavailable on the file system
		String actualNoticeMessage = createRequest.peformLocalInstallBuild("100.0",project,packageName,false,2);
