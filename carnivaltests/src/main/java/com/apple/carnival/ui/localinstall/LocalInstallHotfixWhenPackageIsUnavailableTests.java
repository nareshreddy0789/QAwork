...
public class LocalInstallHotfixWhenPackageIsUnavailableTests {
	...
	public void init(String carnivalHost,String wd40host1, String wd40host2,String domain,String project, String packageName){
		...
		Reporter.log("LocalInstallHotfixWhenPackageIsUnavailableTests tests with the following details :",true);
	...
	public void installPackageUsingValidPackageName() throws InterruptedException {
		...
		//Force Install is set to no. It Acually does not matter if force install is set to Yes or No when the
