...
public class LocalInstallBuildWhenPackageIsUnavailableTests {
	...
	public void init(String carnivalHost,String wd40host1, String wd40host2,String domain,String project, String packageName){
		...
		Reporter.log("LocalInstallBuildWhenPackageIsUnavailableTests tests with the following details :",true);
	...
	public void validateTaskDetailsPage() throws InterruptedException {
	...
	@Test(dependsOnMethods = { "validateTaskDetailsPage" })
	public void validateTaskDetailsLogs() throws InterruptedException {
		Reporter.log("Validate View Logs Page after install",true);
	...
	@Test(dependsOnMethods = { "validateTaskDetailsLogs" })
