...
public class LocalInstallBuildUsingForceInstallOptionWhenPackageIsAvailableTests {
	...
	public void init(String carnivalHost,String wd40host1, String wd40host2,String domain,String project, String packageName){
		...
		Reporter.log("LocalInstallBuildUsingForceInstallOptionWhenPackageIsAvailableTests tests with the following details :",true);
	...
	public void installPackageUsingValidPackageName() throws InterruptedException {
		...
		Reporter.log("Local Install Build from carnival UI with valid package name",true);
		...
		String actualNoticeMessage = createRequest.peformLocalInstallBuild("100.0",project,packageName,true,2);
	...
	public void reinstallExistingPackageUsingForceOption() throws InterruptedException {
	
		Reporter.log("Local Install Build from carnival UI with an already existing package name",true);
	...
	@Test(dependsOnMethods = { "reinstallExistingPackageUsingForceOption" })
	...
	public void validateTaskDetailsLogsAfterReinstall() throws InterruptedException {
		...
		String expectedLogEntry1 = "Determining hosts missing package: "+packageName+".  Sending followup install requests to 2 active host(s).";
		String expectedLogEntry2 = packageName+" has been confirmed on the required 2 hosts below:";
		String expectedLogEntry3 = "Install of "+packageName+" for project "+project+" has succeeded on 100.0% ( 2 out of 2 ) of required hosts.  Acceptance Threshold entered by user: 100.0%.";
		...
		Assert.assertTrue(viewLogs.contains(expectedLogEntry2),"Log Entry should have been there");
