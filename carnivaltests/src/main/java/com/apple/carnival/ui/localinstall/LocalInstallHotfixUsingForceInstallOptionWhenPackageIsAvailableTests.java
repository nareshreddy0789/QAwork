...
public class LocalInstallHotfixUsingForceInstallOptionWhenPackageIsAvailableTests {
	...
	public void init(String carnivalHost,String wd40host1, String wd40host2,String domain,String project, String packageName){
		...
		Reporter.log("LocalInstallHotfixUsingForceInstallOptionWhenPackageIsAvailableTests tests with the following details :",true);
	...
	public void reinstallExistingPackageUsingForceOption() throws InterruptedException {
		...
		//package is unavailable on the file system
		String actualNoticeMessage = createRequest.peformLocalInstallHotfix("100.0",project,packageName,true,2,"New feature");
	...
	public void validateEnvironmentInfoPageToCheckPackageIsNotCurrent() throws InterruptedException {
		...
		Reporter.log("Wait for 15 minutes for the Environemnt Info page to refresh",true);
