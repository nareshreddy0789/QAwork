...
public class AllHostsTests {
	...
	@Data(dataFile="src/main/resources/data/GETAllHostsTestCaseData.JSON")
	public void testGetAllHostsPlainText(TestCase test) throws JSONException{
