...
public class CopyOfAllApplicationTests {
	
	
	@Test
	public void testGetAllApplsPlainText() throws ClientProtocolException, IOException {

		int expectedStatusCode = 200;
		String expectedEntity= "Carnival,WD40OpenMQ,clown";
		Configuration config = new FrameworkConfigurationReader("framework.properties");
		String myResource = config.getProperty("applications.resource");
