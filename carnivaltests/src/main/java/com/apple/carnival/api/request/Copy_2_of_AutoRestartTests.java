...
public class Copy_2_of_AutoRestartTests {
	...
	@Test
	@Parameters({"WD40_HOST","DOMAIN","PROJECT","PACKAGE_TO_INSTALL","EXPECTED_APP_NAME","EXPECTED_INSTANCE"})
	public void init(String wd40Host,@Optional String domain,String project, String packageToInstall,String expectedAppName,String expectedInstance){
		...
		Reporter.log("EXPECTED INSTANCE  :"+expectedInstance,true);
	}
