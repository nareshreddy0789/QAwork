...
public class CopyOfApplicationHostsTests {
	
	
	@Test
	public void testGetHostsForISOpenMQPlainText() throws ClientProtocolException, IOException {

		int expectedStatusCode = 200;
		String expectedEntity= "vp21q01if-ztbu14114601";
		String application="WD40OpenMQ";
		Configuration config = new FrameworkConfigurationReader("framework.properties");
		String myResource = config.getProperty("hosts.applications.resource")+application;
	...
	@Test
	public void testGetHostsForISCarnivalPlainText() throws ClientProtocolException, IOException {
	...
	@Test
	public void testGetHostsForISOpenMQJsonFormat() throws ClientProtocolException, IOException {

		int expectedStatusCode = 200;
		String expectedEntity= "{\"code\":\"SUCCESS\",\"hosts\":[{\"name\":\"vp21q01if-ztbu14114601\",\"datacenter\":\"unknown\"}]}";
		String application="WD40OpenMQ";
		Configuration config = new FrameworkConfigurationReader("framework.properties");
		String myResource = config.getProperty("hosts.applications.resource")+application;
