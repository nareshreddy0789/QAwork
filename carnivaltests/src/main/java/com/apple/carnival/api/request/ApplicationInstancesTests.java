...
public class ApplicationInstancesTests {
	...
	@Data(dataFile="src/main/resources/data/GETApplicationInstancesTestCaseData.JSON")
	public void testGetInstancesForApplication(TestCase test) throws JSONException{
