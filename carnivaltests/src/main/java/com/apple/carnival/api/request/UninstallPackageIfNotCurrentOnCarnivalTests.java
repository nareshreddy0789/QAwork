...
public class UninstallPackageIfNotCurrentOnCarnivalTests {
	...
	public void init(String carnivalHost,String wd40Host, @Optional String domain,String project, String packageName){
		...
		Reporter.log("UninstallPackageIfNotCurrentOnCarnivalTests tests with the following details :",true);
	...
	public void checkIfPackageIsCurrentOnWD40Host() throws InterruptedException {
	...
	@Test(dependsOnMethods = { "checkIfPackageIsCurrentOnWD40Host" })
	...
	public void checkIfPackageIsAvailableOnWD40Host() throws InterruptedException {
		//Wait to synchronize the next page
		Thread.sleep(4000);
		home.getOverViewOfHostsPage();
	...
	@Test(dependsOnMethods = { "checkIfPackageIsAvailableOnWD40Host" })
	public void uninstallPackageFromWD40HostWhileItsNotCurrentOnCarnival() throws InterruptedException {
		...
		String actualNotice = createRequest.addRequestAndScheduleToUninstallPackage("100.0",project, packageName,false,2,null);
	...
	@Test(dependsOnMethods = { "uninstallPackageFromWD40HostWhileItsNotCurrentOnCarnival" })
	public void checkIfPackageIsNotPresentOnWD40Host() throws InterruptedException {
		//Wait for 15 mins to change the status to Current on Environment Info Page
		Thread.sleep(950000);
		home.getOverViewOfHostsPage();
	...
	@Test(dependsOnMethods = { "checkIfPackageIsNotPresentOnWD40Host" })
	...
	public void sshCheckPackageDoesNotExistsOnWD40Host() throws InterruptedException {
